  ...
  return (
    <div style={{ background: "oklch(0.06 0 0)", minHeight: "100vh" }}>
      ...
      <main className="max-w-2xl mx-auto px-6 py-20">
        ...
        <p style={p}>
          MRKT is operated by MRKT ("Company", "we", "us", "our"), serving users globally. Our registered legal entity and jurisdiction of incorporation are being finalized as part of our company registration process; the confirmed entity name and registered address will be published here once complete. Legal and privacy correspondence should be directed to <a href="mailto:legal@usemrkt.app" style={a}>legal@usemrkt.app</a>.
        </p>
        ...
        <h3 style={h3}>7.1 Refunds and Cancellations</h3>
        <p style={p}>
          Campaign payments processed through MRKT are held for the benefit of the Creator once a deliverable is approved; MRKT does not independently guarantee refunds for collaborations between Creators and Businesses. If a payment was charged in error, or a campaign is cancelled before any deliverable is approved, contact <a href="mailto:legal@usemrkt.app" style={a}>legal@usemrkt.app</a> within 14 days of the charge — refund requests are reviewed case by case and, where approved, are returned via Stripe to the original payment method. MRKT's platform fee is non-refundable once a deliverable has been approved and paid out. This section will be superseded by a dedicated Refund Policy at the time subscription plans (Creator Pro, Business Growth) are formally launched.
        </p>
        ...
        <p style={p}>
          <strong style={{ color: "oklch(1 0 0 / 72%)" }}>AI Disclosure:</strong> All AI outputs are generated by third-party AI providers (including Anthropic, OpenAI, and Higgsfield for image/video generation) and presented under the MRKT AI brand. AI outputs are for guidance and inspiration only. MRKT does not guarantee accuracy, completeness, or fitness for purpose. You must review all AI outputs before relying on or publishing them. You are solely responsible for content you publish based on AI suggestions.
        </p>
        <p style={p}>
        ...
        <p style={p}>
          These Terms are governed by the laws of MRKT's jurisdiction of incorporation, to be confirmed and published here once our company registration is complete (see §1). Nothing in these Terms limits mandatory consumer protection rights you may have under the laws of your country of residence.
        </p>
